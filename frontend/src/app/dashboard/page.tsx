  ...
  useEffect(() => {
    async function fetchStats() {
      ...
      if (data && !error) {
        ...
        setTotalTopics(uniqueTopics.size.toString());
      }
    }
    fetchStats();
  }, []);
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {stats.map((stat, i) => (
          ...
          >
            <div className="absolute top-0 right-0 w-24 h-24 bg-white/5 rounded-full blur-2xl -mr-8 -mt-8 group-hover:bg-primary/10 transition-colors"></div>
